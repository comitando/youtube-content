...
final class ProductDetailView: UIView {
    ...
    private lazy var nameLabel: UILabel = {
        ...
        element.attributedText = Strings.name.getAttributedString()
        return element
    }()
    ...
    private lazy var descriptionLabel: UILabel = {
        ...
        element.numberOfLines = 0
        element.textAlignment = .left
        element.attributedText = Strings.description.getAttributedString()
        return element
    }()
    
    // Bullets
    private lazy var bullet1 = BulletItemView(labelValue: Strings.bullet1.getAttributedString())
    private lazy var bullet2 = BulletItemView(labelValue: Strings.bullet2.getAttributedString())
    private lazy var bullet3 = BulletItemView(labelValue: Strings.bullet3.getAttributedString())
    private lazy var bullet4 = BulletItemView(labelValue: Strings.bullet4.getAttributedString())
    private lazy var bullet5 = BulletItemView(labelValue: Strings.bullet5.getAttributedString())
    
    private lazy var productPriceView = ProductPriceView(
        price: Strings.price.getAttributedString(with: [(text: Strings.price,
                                                         attributes: [
                                                            .strikethroughStyle: NSUnderlineStyle.single.rawValue
                                                         ])]),
        pixPrice: Strings.pixPrice.getAttributedString(),
        pixMessage: Strings.pixMessage.getAttributedString(with: [(text: Strings.pixHighlight,
                                                                   attributes: [
                                                                    .foregroundColor: Asset.Colors.techGreen2.color
                                                                   ])]),
        installmentsMessage: Strings.installmentsMessage.getAttributedString()
    )
