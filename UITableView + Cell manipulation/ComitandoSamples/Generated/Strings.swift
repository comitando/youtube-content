...
internal enum Strings {
  ...
  /// +
  internal static let buttonAdd = Strings.tr("Localizable", "buttonAdd", fallback: "+")
  /// Adicionar ao carrinho
  internal static let buttonAddToCart = Strings.tr("Localizable", "buttonAddToCart", fallback: "Adicionar ao carrinho")
  /// comprar agora
  ...
  /// Lista de Produtos
  internal static let listNavigationTitle = Strings.tr("Localizable", "listNavigationTitle", fallback: "Lista de Produtos")
